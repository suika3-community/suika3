...
static struct rule {
	...
	{'s',	"font.ttf2",			&conf_font_ttf[1],			MUST,	SAVE,	GLOBAL},
	{'s',	"font.ttf3",			&conf_font_ttf[2],			MUST,	SAVE,	GLOBAL},
	{'s',	"font.ttf4",			&conf_font_ttf[3],			MUST,	SAVE,	GLOBAL},
	...
	{'b',	"msgbox.dim",			&conf_msgbox_dim_enable,		MUST,	SAVE,	LOCAL},
	...
	{'b',	"msgbox.seen",			&conf_msgbox_seen_enable,		MUST,	SAVE,	LOCAL},
	...
	{'b',	"msgbox.show.on.ch",		&conf_msgbox_show_on_ch,		MUST,	SAVE,	LOCAL},
	{'b',	"msgbox.show.on.bg",		&conf_msgbox_show_on_bg,		MUST,	SAVE,	LOCAL},
	{'b',	"msgbox.show.on.choose",	&conf_msgbox_show_on_choose,		MUST,	SAVE,	LOCAL},
	{'b',	"msgbox.skip.unseen",		&conf_msgbox_skip_unseen,		MUST,	SAVE,	LOCAL},
	...
	{'s',	"click.image2",			&conf_click_image[1],			MUST,	SAVE,	LOCAL},
	{'s',	"click.image3",			&conf_click_image[2],			MUST,	SAVE,	LOCAL},
	{'s',	"click.image4",			&conf_click_image[3],			MUST,	SAVE,	LOCAL},
	{'s',	"click.image5",			&conf_click_image[4],			MUST,	SAVE,	LOCAL},
	{'s',	"click.image6",			&conf_click_image[5],			MUST,	SAVE,	LOCAL},
	{'s',	"click.image7",			&conf_click_image[6],			MUST,	SAVE,	LOCAL},
	{'s',	"click.image8",			&conf_click_image[7],			MUST,	SAVE,	LOCAL},
	{'s',	"click.image9",			&conf_click_image[8],			MUST,	SAVE,	LOCAL},
	{'s',	"click.image10",		&conf_click_image[9],			MUST,	SAVE,	LOCAL},
	{'s',	"click.image11",		&conf_click_image[10],			MUST,	SAVE,	LOCAL},
	{'s',	"click.image12",		&conf_click_image[11],			MUST,	SAVE,	LOCAL},
	{'s',	"click.image13",		&conf_click_image[12],			MUST,	SAVE,	LOCAL},
	{'s',	"click.image14",		&conf_click_image[13],			MUST,	SAVE,	LOCAL},
	{'s',	"click.image15",		&conf_click_image[14],			MUST,	SAVE,	LOCAL},
	{'s',	"click.image16",		&conf_click_image[15],			MUST,	SAVE,	LOCAL},
	...
	{'s',	"choose.change.se",		&conf_choose_change_se,			MUST,	SAVE,	LOCAL},
	{'s',	"choose.click.se",		&conf_choose_click_se,			MUST,	SAVE,	LOCAL},
	{'s',	"choose.idle1",			&conf_choose_idle[0],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.hover1",		&conf_choose_hover[0],		MUST,	SAVE,	LOCAL},
	{'i',	"choose.x1",			&conf_choose_x[0],			MUST,	SAVE,	LOCAL},
	{'i',	"choose.y1",			&conf_choose_y[0],			MUST,	SAVE,	LOCAL},
	{'i',	"choose.margin.top1",		&conf_choose_margin_top[0],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.focus_anime1",		&conf_choose_focus_anime[0],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.unfocus_anime1",	&conf_choose_unfocus_anime[0],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.idle2",			&conf_choose_idle[1],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.hover2",		&conf_choose_hover[1],		MUST,	SAVE,	LOCAL},
	{'i',	"choose.x2",			&conf_choose_x[1],			MUST,	SAVE,	LOCAL},
	{'i',	"choose.y2",			&conf_choose_y[1],			MUST,	SAVE,	LOCAL},
	{'i',	"choose.margin.top2",		&conf_choose_margin_top[1],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.focus_anime2",		&conf_choose_focus_anime[1],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.unfocus_anime2",	&conf_choose_unfocus_anime[1],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.idle3",			&conf_choose_idle[2],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.hover3",		&conf_choose_hover[2],		MUST,	SAVE,	LOCAL},
	{'i',	"choose.x3",			&conf_choose_x[2],			MUST,	SAVE,	LOCAL},
	{'i',	"choose.y3",			&conf_choose_y[2],			MUST,	SAVE,	LOCAL},
	{'i',	"choose.margin.top3",		&conf_choose_margin_top[2],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.focus_anime3",		&conf_choose_focus_anime[2],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.unfocus_anime3",	&conf_choose_unfocus_anime[2],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.idle4",			&conf_choose_idle[3],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.hover4",		&conf_choose_hover[3],		MUST,	SAVE,	LOCAL},
	{'i',	"choose.x4",			&conf_choose_x[3],			MUST,	SAVE,	LOCAL},
	{'i',	"choose.y4",			&conf_choose_y[3],			MUST,	SAVE,	LOCAL},
	{'i',	"choose.margin.top4",		&conf_choose_margin_top[3],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.focus_anime4",		&conf_choose_focus_anime[3],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.unfocus_anime4",	&conf_choose_unfocus_anime[3],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.idle5",			&conf_choose_idle[4],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.hover5",		&conf_choose_hover[4],		MUST,	SAVE,	LOCAL},
	{'i',	"choose.x5",			&conf_choose_x[4],			MUST,	SAVE,	LOCAL},
	{'i',	"choose.y5",			&conf_choose_y[4],			MUST,	SAVE,	LOCAL},
	{'i',	"choose.margin.top5",		&conf_choose_margin_top[4],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.focus_anime5",		&conf_choose_focus_anime[4],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.unfocus_anime5",	&conf_choose_unfocus_anime[4],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.idle6",			&conf_choose_idle[5],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.hover6",		&conf_choose_hover[5],		MUST,	SAVE,	LOCAL},
	{'i',	"choose.x6",			&conf_choose_x[5],			MUST,	SAVE,	LOCAL},
	{'i',	"choose.y6",			&conf_choose_y[5],			MUST,	SAVE,	LOCAL},
	{'i',	"choose.margin.top6",		&conf_choose_margin_top[5],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.focus_anime6",		&conf_choose_focus_anime[5],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.unfocus_anime6",	&conf_choose_unfocus_anime[5],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.idle7",			&conf_choose_idle[6],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.hover7",		&conf_choose_hover[6],		MUST,	SAVE,	LOCAL},
	{'i',	"choose.x7",			&conf_choose_x[6],			MUST,	SAVE,	LOCAL},
	{'i',	"choose.y7",			&conf_choose_y[6],			MUST,	SAVE,	LOCAL},
	{'i',	"choose.margin.top7",		&conf_choose_margin_top[6],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.focus_anime7",		&conf_choose_focus_anime[6],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.unfocus_anime7",	&conf_choose_unfocus_anime[6],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.idle8",			&conf_choose_idle[7],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.hover8",		&conf_choose_hover[7],		MUST,	SAVE,	LOCAL},
	{'i',	"choose.x8",			&conf_choose_x[7],			MUST,	SAVE,	LOCAL},
	{'i',	"choose.y8",			&conf_choose_y[7],			MUST,	SAVE,	LOCAL},
	{'i',	"choose.margin.top8",		&conf_choose_margin_top[7],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.focus_anime8",		&conf_choose_focus_anime[7],		MUST,	SAVE,	LOCAL},
	{'s',	"choose.unfocus_anime8",	&conf_choose_unfocus_anime[7],		MUST,	SAVE,	LOCAL},

	/* Save Data */
	{'i',	"save.thumb.width",		&conf_save_thumb_width,			MUST,	NOSAVE,	GLOBAL},
	{'i',	"save.thumb.height",		&conf_save_thumb_height,		MUST,	NOSAVE,	GLOBAL},
	{'s',	"save.new.image",		&conf_save_new_image,			MUST,	NOSAVE,	GLOBAL},
	...
	{'s',	"sysbtn.enter_se",		&conf_sysbtn_enter_se,			MUST,	SAVE,	LOCAL},
	{'s',	"sysbtn.leave_se",		&conf_sysbtn_leave_se,			MUST,	SAVE,	LOCAL},
	{'s',	"sysbtn.click_se",		&conf_sysbtn_click_se,			MUST,	SAVE,	LOCAL},
	...
	{'s',	"automode.enter_se",		&conf_automode_enter_se,		MUST,	SAVE,	LOCAL},
	{'s',	"automode.leave_se",		&conf_automode_leave_se,		MUST,	SAVE,	LOCAL},
	...
	{'s',	"skipmode.enter.se",		&conf_skipmode_enter_se,		MUST,	SAVE,	LOCAL},
	{'s',	"skipmode.leave.se",		&conf_skipmode_leave_se,		MUST,	SAVE,	LOCAL},
	...
	{'s',	"character.name1",		&conf_character_name[0],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder1",		&conf_character_folder[0],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name2",		&conf_character_name[1],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder2",		&conf_character_folder[1],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name3",		&conf_character_name[2],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder3",		&conf_character_folder[2],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name4",		&conf_character_name[3],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder4",		&conf_character_folder[3],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name5",		&conf_character_name[4],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder5",		&conf_character_folder[4],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name6",		&conf_character_name[5],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder6",		&conf_character_folder[5],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name7",		&conf_character_name[6],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder7",		&conf_character_folder[6],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name8",		&conf_character_name[7],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder8",		&conf_character_folder[7],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name9",		&conf_character_name[8],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder9",		&conf_character_folder[8],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name10",		&conf_character_name[9],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder10",		&conf_character_folder[9],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name11",		&conf_character_name[10],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder11",		&conf_character_folder[10],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name12",		&conf_character_name[11],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder12",		&conf_character_folder[11],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name13",		&conf_character_name[12],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder13",		&conf_character_folder[12],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name14",		&conf_character_name[13],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder14",		&conf_character_folder[13],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name15",		&conf_character_name[14],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder15",		&conf_character_folder[14],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name16",		&conf_character_name[15],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder16",		&conf_character_folder[15],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name17",		&conf_character_name[16],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder17",		&conf_character_folder[16],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name18",		&conf_character_name[17],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder18",		&conf_character_folder[17],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name19",		&conf_character_name[18],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder19",		&conf_character_folder[18],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name20",		&conf_character_name[19],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder20",		&conf_character_folder[19],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name21",		&conf_character_name[20],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder21",		&conf_character_folder[20],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name22",		&conf_character_name[21],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder22",		&conf_character_folder[21],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name23",		&conf_character_name[22],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder23",		&conf_character_folder[22],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name24",		&conf_character_name[23],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder24",		&conf_character_folder[23],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name25",		&conf_character_name[24],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder25",		&conf_character_folder[24],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name26",		&conf_character_name[25],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder26",		&conf_character_folder[25],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name27",		&conf_character_name[26],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder27",		&conf_character_folder[26],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name28",		&conf_character_name[27],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder28",		&conf_character_folder[27],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name29",		&conf_character_name[28],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder29",		&conf_character_folder[28],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name30",		&conf_character_name[29],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder30",		&conf_character_folder[29],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name31",		&conf_character_name[30],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder31",		&conf_character_folder[30],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.name32",		&conf_character_name[31],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"character.folder32",		&conf_character_folder[31],		MUST,	NOSAVE,	GLOBAL},

	/* Stage Margins */
	{'i',	"stage.ch.margin.bottom",	&conf_stage_ch_margin_bottom,		MUST,	SAVE,	LOCAL},
	{'i',	"stage.ch.margin.left",		&conf_stage_ch_margin_left,		MUST,	SAVE,	LOCAL},
	{'i',	"stage.ch.margin.right",	&conf_stage_ch_margin_right,		MUST,	SAVE,	LOCAL},

	/* Kira Kira Effect */
	{'b',	"kirakira.enable",		&conf_kirakira_enable,			MUST,	NOSAVE,	GLOBAL},
	{'b',	"kirakira.add",			&conf_kirakira_add_blend,		MUST,	NOSAVE,	GLOBAL},
	{'f',	"kirakira.frame",		&conf_kirakira_frame,			MUST,	NOSAVE,	GLOBAL},
	{'s',	"kirakira.image1",		&conf_kirakira_image[0],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"kirakira.image2",		&conf_kirakira_image[1],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"kirakira.image3",		&conf_kirakira_image[2],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"kirakira.image4",		&conf_kirakira_image[3],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"kirakira.image5",		&conf_kirakira_image[4],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"kirakira.image6",		&conf_kirakira_image[5],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"kirakira.image7",		&conf_kirakira_image[6],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"kirakira.image8",		&conf_kirakira_image[7],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"kirakira.image9",		&conf_kirakira_image[8],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"kirakira.image10",		&conf_kirakira_image[9],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"kirakira.image11",		&conf_kirakira_image[10],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"kirakira.image12",		&conf_kirakira_image[11],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"kirakira.image13",		&conf_kirakira_image[12],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"kirakira.image14",		&conf_kirakira_image[13],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"kirakira.image15",		&conf_kirakira_image[14],		MUST,	NOSAVE,	GLOBAL},
	{'s',	"kirakira.image16",		&conf_kirakira_image[15],		MUST,	NOSAVE,	GLOBAL},

	/* Emoji */
	{'s',	"emoji.name1",		&conf_emoji_name[0],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name2",		&conf_emoji_name[1],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name3",		&conf_emoji_name[2],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name4",		&conf_emoji_name[3],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name5",		&conf_emoji_name[4],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name6",		&conf_emoji_name[5],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name7",		&conf_emoji_name[6],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name8",		&conf_emoji_name[7],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name9",		&conf_emoji_name[8],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name10",		&conf_emoji_name[9],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name11",		&conf_emoji_name[10],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name12",		&conf_emoji_name[11],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name13",		&conf_emoji_name[12],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name14",		&conf_emoji_name[13],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name15",		&conf_emoji_name[14],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name16",		&conf_emoji_name[15],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name17",		&conf_emoji_name[16],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name18",		&conf_emoji_name[17],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name19",		&conf_emoji_name[18],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name20",		&conf_emoji_name[19],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name21",		&conf_emoji_name[20],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name22",		&conf_emoji_name[21],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name23",		&conf_emoji_name[22],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name24",		&conf_emoji_name[23],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name25",		&conf_emoji_name[24],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name26",		&conf_emoji_name[25],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name27",		&conf_emoji_name[26],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name28",		&conf_emoji_name[27],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name29",		&conf_emoji_name[28],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name30",		&conf_emoji_name[29],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name31",		&conf_emoji_name[30],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.name32",		&conf_emoji_name[31],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image1",		&conf_emoji_image[0],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image2",		&conf_emoji_image[1],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image3",		&conf_emoji_image[2],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image4",		&conf_emoji_image[3],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image5",		&conf_emoji_image[4],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image6",		&conf_emoji_image[5],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image7",		&conf_emoji_image[6],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image8",		&conf_emoji_image[7],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image9",		&conf_emoji_image[8],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image10",	&conf_emoji_image[9],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image11",	&conf_emoji_image[10],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image12",	&conf_emoji_image[11],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image13",	&conf_emoji_image[12],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image14",	&conf_emoji_image[13],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image15",	&conf_emoji_image[14],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image16",	&conf_emoji_image[15],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image17",	&conf_emoji_image[16],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image18",	&conf_emoji_image[17],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image19",	&conf_emoji_image[18],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image20",	&conf_emoji_image[19],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image21",	&conf_emoji_image[20],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image22",	&conf_emoji_image[21],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image23",	&conf_emoji_image[22],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image24",	&conf_emoji_image[23],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image25",	&conf_emoji_image[24],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image26",	&conf_emoji_image[25],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image27",	&conf_emoji_image[26],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image28",	&conf_emoji_image[27],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image29",	&conf_emoji_image[28],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image30",	&conf_emoji_image[29],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image31",	&conf_emoji_image[30],			MUST,	NOSAVE,	GLOBAL},
	{'s',	"emoji.image32",	&conf_emoji_image[31],			MUST,	NOSAVE,	GLOBAL},
...
static bool read_conf(void)
{
	...
	while (*line_ptr) {
		...
		v = strtok(NULL, "=");
		if (v == NULL || v[0] == '\0') {
			s3_log_error(S3_TR("Empty config file."));
			free(file_buf);
			return false;
		}
